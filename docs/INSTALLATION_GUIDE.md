...
**KB React Calculator** - Setup Instructions

[🇺🇸 English](./INSTALLATION_GUIDE.md) | [🇪🇸 Español](./INSTALLATION_GUIDE_ES.md) | [⬅ Back](../README.md)

</div>

---

This guide provides detailed instructions to set up and run the project.
...
1. **Clone the Repository**:
   - Open a terminal and run:
     ...
     ```
   - This will clone the KB React Calculator project to your local machine.
...
[⬆ Back to top](#-installation-guide) | [📖 Docs](../docs/) | [🐛 Issues](https://github.com/KRSNA-BLR/Beginner-Friendly-React-Native-Calculator-App/issues)
